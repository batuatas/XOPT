#!/usr/bin/env python3
"""Run the XOPTPOE v3 long-horizon E2E / PAO model."""
...
from xoptpoe_v3_models.e2e import run_v3_e2e  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Run v3 long-horizon E2E / PAO model')
