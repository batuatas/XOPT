#!/usr/bin/env python3
"""Run the v3 long-horizon prediction ablation study."""
...
from xoptpoe_v3_models.prediction_ablation import run_prediction_ablation  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Run v3 long-horizon prediction ablation study')
