#!/usr/bin/env python3
"""Run the XOPTPOE v2 long-horizon PTO model."""
...
from xoptpoe_v2_models.pto import run_v2_pto  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Run v2 long-horizon PTO model')
