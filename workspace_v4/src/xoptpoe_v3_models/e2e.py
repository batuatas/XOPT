"""End-to-end predict-and-optimize workflow for XOPTPOE v3 long-horizon SAA."""
...
from xoptpoe_v3_models.losses import objective_score
...
def _render_e2e_report(
    *,
    ...
    lines: list[str] = []
    lines.append("# XOPTPOE v3 E2E / PAO Report")
    lines.append("")
    ...
    lines.append("- The paper’s stock-ranking universe step is removed because the SAA universe is the active 9-sleeve v3 investable universe with EQ_CN included.")
    ...
    lines.append("- The optimizer still follows the paper’s robust long-only mean-variance form, but Sigma is estimated from v3 sleeve-level trailing monthly excess returns across all 9 sleeves rather than stock-level firm panels.")
