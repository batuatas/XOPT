"""Prediction-focused ablations and diagnostics for XOPTPOE v3 long-horizon modeling."""
...
from xoptpoe_v3_models.evaluate import regression_metrics
...
def _render_report(
    *,
    ...
    lines: list[str] = []
    lines.append("# XOPTPOE v3 Prediction Ablation Report")
    lines.append("")
    lines.append("## Scope")
