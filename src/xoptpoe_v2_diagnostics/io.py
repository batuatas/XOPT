"""I/O helpers for the v2 SAA diagnostics package."""
...
def default_paths(project_root: Path) -> DiagnosticPaths:
    ...
    return DiagnosticPaths(
        project_root=root,
        predictions_validation=root / 'data' / 'modeling_v2' / 'predictions_validation_horse_race.parquet',
        predictions_test=root / 'data' / 'modeling_v2' / 'predictions_test_horse_race.parquet',
        portfolio_comparison_metrics=reports_dir / 'saa_portfolio_comparison_metrics.csv',
        portfolio_comparison_returns=root / 'data' / 'modeling_v2' / 'portfolio_comparison_returns.csv',
        ...
        modeling_panel_firstpass=root / 'data' / 'modeling_v2' / 'modeling_panel_firstpass.parquet',
