"""Professor-facing report builder for the v2 SAA diagnostics package."""
...
def build_report(
    *,
    ...
    lines: list[str] = []
    lines.append('# XOPTPOE v2 SAA Diagnostics Report')
    lines.append('')
    lines.append('## Scope And Caveat')
    lines.append('- These outputs are long-horizon SAA decision-period diagnostics built on the frozen v2 dataset and the existing horse-race / PTO / E2E outputs.')
