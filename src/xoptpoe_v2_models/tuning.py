"""Narrow tuning and diagnostic study for XOPTPOE v2 PTO/E2E models."""
...
from xoptpoe_v2_models.losses import mse_loss, objective_score
...
def run_e2e_tuning_and_diagnostics(
    *,
    ...
    lines: list[str] = []
    lines.append("# XOPTPOE v2 E2E Tuning Report")
    lines.append("")
    lines.append("## Scope")
